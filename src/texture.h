...
class solid_colour : public texture {
    public:
        ...
        solid_colour(float red, float green, float blue) : solid_colour(colour(red, green, blue)) {}

        colour value(float u, float v, const point3& p) const override { return albedo; }
...
class checker_texture : public texture {
    public:
        ...
        checker_texture(float scale, const colour& c1, const colour& c2) : checker_texture(scale, make_shared<solid_colour>(c1), make_shared<solid_colour>(c2)) {}
